                            ...
                            <div className="px-4 pt-5 pb-4">
                                <div className="sm:flex sm:items-start sm:justify-between">
                                    <div className="sm:flex sm:items-center sm:justify-between">
                                        <Dialog.Title as="h3"
                                                      className="text-lg font-semibold leading-6 text-gray-900 sm:mr-4">
                                            Legend
                                        </Dialog.Title>
                                    </div>
                                ...
                                <div className="mt-4">
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        ...
                                        <p className="text-base text-gray-700">Up Temperature: Temperature is going
                                            up</p>
                                    </div>
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        <div className="flex-shrink-0 h-8 w-8 mr-3">
                                        ...
                                        <p className="text-base text-gray-700">Down Temperature: Temperature is going
                                            down</p>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        ...
                                        <p className="text-base text-gray-700">Yellow Alert: Reached Hot Threshold</p>
                                    </div>
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        <div className="flex-shrink-0 h-8 w-8 mr-3">
                                            <RedAlert className="h-6 w-6 text-red-600" aria-hidden="true"/>
                                        </div>
                                        <p className="text-base text-gray-700">Red Alert: Reached Danger Threshold</p>
                                    </div>
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        <div className="flex-shrink-0 h-8 w-8 mr-3">
                                            <Snowflake className="h-6 w-6 text-blue-600" aria-hidden="true"/>
                                        </div>
                                        <p className="text-base text-gray-700">Cold: Reached Cold Threshold</p>
                                    </div>
                                    <div className="flex items-center justify-start m-4 gap-3">
                                        <div className="flex-shrink-0 h-8 w-8 mr-3">
                                            <NormalTemperature className="h-6 w-6 text-green-600" aria-hidden="true"/>
                                        </div>
                                        <p className="text-base text-gray-700">Normal: Reached Normal Threshold</p>
                                    </div>
                                </div>
                            </div>
                        </div>
