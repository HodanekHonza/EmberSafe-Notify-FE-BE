// Formula for rotate circle on TemteratureMometr
export default function RotateDeg(RoomData){
    const Rotate = (RoomData.CurrentTemperature * 180) / (RoomData.Cold[0] + RoomData.Dangerous[1]) 
    if(Rotate <= 0){
        return 0
    }
    else if(Rotate >= 180)
...
export const CurTempInfo = (RoomData) => RoomData.CurrentTemperature <= RoomData.Cold[1]
? ["blue", "Cold"]
...
? ["orange", 'Hot']
: RoomData.CurrentTemperature >= RoomData.Dangerous[0]
? ["red", "Dangerous"]
: ["red", "Dangerous"];
